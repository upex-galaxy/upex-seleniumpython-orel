...
class Test_Elements_Button:
    ...
    def test_should_display_message_by_left_click(self, driver):
        ...
        buttons_page.locators.wait_for_element(buttons_page.driver.find_element(By.ID, "doubleClickBtn"))

        button = buttons_page.locators.get_by_text("Click Me", True)[0]
        button.click()
    ...
    def test_right_click(self, driver):
        ...
        buttons_page.locators.wait_for_element(buttons_page.driver.find_element(By.ID, "rightClickBtn"))
